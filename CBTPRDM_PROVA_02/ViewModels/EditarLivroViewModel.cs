...
{
    [QueryProperty(nameof(Livro), "LivroData")]
    public partial class EditarLivroViewModel : ObservableObject
    {
        ...
        public EditarLivroViewModel(LivroRepository livroRepository)
        {
